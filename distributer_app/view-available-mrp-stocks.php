...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-available-mrp-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
                    ...
                    $sql = "SELECT * FROM tbl_mrp_available_stock_inv WHERE FrId='$FranchiseId' AND ProdType=0";
                            $row = getList($sql);
                            foreach($row as $result){
                               
                            ?>
                        <div class="card mb-4">
                            <a href="view-available-mrp-product.php?id=<?php echo $result['id'];?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
