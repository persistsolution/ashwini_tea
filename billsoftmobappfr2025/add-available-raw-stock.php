    ...
    .autocomplete-list3 {
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                ...
                <div class="card mb-4">
                    <form id="validation-form" method="post" enctype="multipart/form-data" action="save-available-raw-stock.php">
                        <div class="card-body">
<div class="form-row">
...
<input type="text" name="PurchasePrice" id="PurchasePrice" class="form-control" placeholder="" value="" autocomplete="off" oninput="calTotalPrice()" readonly>
<div class="clearfix"></div>
    </div>
...
<div class="input-group">
   ...
   <input type="hidden" class="form-control" name="Unit" id="QtyUnit" value="<?php echo $row7["Unit"]; ?>">
    ...
    <div class="form-group col-md-2 col-4" style="padding-top: 25px;">
