...
<?php 
$id = $_GET['id'];
$sql7 = "SELECT * FROM tbl_mrp_available_stock WHERE id='$id'";
    ...
    .autocomplete-list3 {
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                ...
                <div class="card mb-4">
                    <form id="validation-form" method="post" enctype="multipart/form-data" action="save-available-mrp-stock.php">
                        <div class="card-body">
<div class="form-row">

<!--<div class="form-group col-md-12">
<label class="form-label"> Category<span class="text-danger">*</span></label>
 <select class="form-control" name="CatId" id="CatId"  onchange="getSubCat(this.value)">
...
<label class="form-label"> Sub Category<span class="text-danger">*</span></label>
 ...
 onchange="getProduct(this.value, document.getElementById('CatId').value)" >
...
<!--<div class="form-group col-md-12">
  ...
  <select class="form-control" name="ProdId" id="ProdId" onchange="getAvailProdStock(this.value)">
...
<label class="form-label">Available Stock In Qty </label>
...
<input type="date" name="StockDate" id="StockDate" class="form-control" placeholder="" value="<?php echo date('Y-m-d'); ?>" autocomplete="off" readonly>
<div class="clearfix"></div>
    </div>
...
$(document).ready(function() {
    // Initialize Select2 with always-visible search
    $('#ProdId').select2({
...
function getSubCat(catid){
    $.ajax({
        url: "ajax_files/ajax_dropdown.php",
        type: "POST",
        data: { action: "getSubCat", catid: catid },
        success: function(data) {
            console.log(data);
            $('#SubCatId').html(data).val(null).trigger('change');
        }
    });
}
// Load products by category
/*function getProduct(subcatid, catid){
    ...
    $.ajax({
        ...
        success: function(data) {
            console.log(data);
            // ✅ just update product dropdown, no recursion
            $('#ProdId').html(data).val('');
        }
    });
}*/
