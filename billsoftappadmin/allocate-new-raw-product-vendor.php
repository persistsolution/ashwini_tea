...
<h4 class="font-weight-bold py-3 mb-0">Allocate Raw Products To <?php echo $_GET['ShopName'];?>
</h4>

<div class="card">
<div class="card-datatable table-responsive">
    <form id="validation-form" method="post" enctype="multipart/form-data" action="assign-new-raw-product-vendor.php">
        ...
        <tbody>
            ...
            $row22['AllocateProd'] = explode(',',$row22['AllocateProd']);
             ...
             $sql = "SELECT p.ProductName,p.BarcodeNo,p.checkstatus,p.id,p.ProdType2,p.MinPrice,c.Name As Category,cs.Name As SubCatName FROM tbl_cust_products2 p 
                    ...
                    LEFT JOIN tbl_cust_sub_category_2025 cs ON cs.id=p.SubCatId WHERE p.ProdType=1 AND p.OldNew=1 ORDER BY p.ProductName";
            $res = $conn->query($sql);
