<?php 
// Show all errors while debugging dashboard display issues
                            ...
                            <li class="list-group-item" style="border-radius: 10px;"> 
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto" align="right" >
                                         ...
                                         <br><span style="font-size:12px;">Avg : <?php echo ($row88['TotInv']>0)?number_format($NetAmount/$row88['TotInv'],2):'0.00';?></span></p>
                                    </div>
                                </div>
                            </li>
                            </a>
                            ...
                            <li class="list-group-item" style="border-radius: 0px;">
                             ...
                             <li class="list-group-item" style="border-radius: 0px;">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto" align="right" >
                                         <p class="small text-secondary" style="font-size:15px;"><strong><?php echo ($rncnt224>0)?number_format(($TotNetAmount)/$rncnt224,2):'0.00';?></strong></p>
                                    </div> 
                                </div>
                            </li>
