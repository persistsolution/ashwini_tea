...
<div class="login-7">
                    ...
                    <div class="form-info">
                        <div class="form-section align-self-center">
                           <!-- <div class="btn-section clearfix">
                            ...
                            <?php if($_REQUEST['phone'] == '9595454957' || $_REQUEST['phone'] == '8956627166' || $_REQUEST['phone'] == '7709171155' || $_REQUEST['phone'] == '9890233291'){
    ...
    <div class="input-group">
        <input name="YourOtp" id="YourOtp" type="password" 
               class="form-control" placeholder="Enter Your OTP" 
               aria-label="OTP" value="<?php echo $fillotp;?>">
        <span class="input-group-text" onclick="toggleOtp()" style="cursor: pointer;">
...
function toggleOtp() {
    var otpInput = document.getElementById("YourOtp");
...
// Detect DevTools open using console trick
setInterval(function() {
    const start = performance.now();
    debugger; // if DevTools open, this will take longer
