...
<li class="sidenav-item">
<a href="franchise-wise-top-sell-dashboard-new.php" class="sidenav-link">
<div> Franchise Wise New</div>
<?php if($Page=='Weekly-Sale-Report-2') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
...
<li class="sidenav-item">
<a href="view-distributers.php" class="sidenav-link">
<div> Distributers</div>
<?php if($Page=='View-Distributers') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
...
<li class="sidenav-item <?php if($MainPage == 'Selling-Products'){?> open active <?php } ?>">
            ...
            <ul class="sidenav-menu">
                ...
                <?php } if(in_array("12", $Options)) {?>
                <!-- <li class="sidenav-item">
                    <a href="view-cross-sale-products.php" class="sidenav-link">
                        <div>Cross Sale Products</div>
                        <?php if($Page=='Products') {?>
                        <div class="pl-1 ml-auto">
                            <span class="badge badge-dot badge-primary"></span>
                        </div>
...
<?php } if(in_array("26", $Options)) {?>
                <li class="sidenav-item">
                    <a href="view-allocate-new-raw-products.php" class="sidenav-link">
                        <div> Allocate Products</div>
                ...
                <li class="sidenav-item">
                    <a href="view-allocate-new-raw-products-vendor.php" class="sidenav-link">
                        <div> Allocate Products To Vendor</div>
                        <?php if($Page=='Allocate-Products') {?>
                        <div class="pl-1 ml-auto">
                            <span class="badge badge-dot badge-primary"></span>
...
<?php } if(in_array("124", $Options) || in_array("125", $Options) || in_array("126", $Options)) {?>
        <!-- <li class="sidenav-item <?php if($MainPage == 'Raw-Products'){?> open active <?php } ?>">
            <a href="javascript:" class="sidenav-link sidenav-toggle">
                <div>Old Raw Products</div>
            </a>
            <ul class="sidenav-menu">
                ...
                <li class="sidenav-item">
                    <a href="view-old-raw-products.php" class="sidenav-link">
                        <div> Products</div>
                        <?php if($Page=='View-Raw-Product') {?>
                        <div class="pl-1 ml-auto">
                            <span class="badge badge-dot badge-primary"></span>
...
<!-- <li class="sidenav-item">
<a href="sell-report-fmcg-mg.php" class="sidenav-link">
<div> Sell report FMCG MG</div>
<?php if($Page=='Discount-Report-2025') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
