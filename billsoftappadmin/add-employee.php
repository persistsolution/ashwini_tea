...
$adminSections = [
    // Roll = 1
    ['title' => 'Dashboard',               'ids' => [2,3],                                        'roll' => 1],
    ['title' => 'Top Sell Dashboard',      'ids' => [4,6,130],                                        'roll' => 1],
    ['title' => 'Accounts',                'ids' => [7,8,131,132,133],                                       'roll' => 1],
    ['title' => 'Selling Products',        'ids' => [9,12,13,15,58,68,69,60],  'roll' => 1],
    
    ['title' => 'Godown Products',        'ids' => [118,119,70,120],  'roll' => 1],
    ['title' => 'Godown',                  'ids' => [28,29,30,31,122],                      'roll' => 1],
    ['title' => 'Franchise Stock Request', 'ids' => [36,37,38],                                     'roll' => 1],
    
    ['title' => 'Reports',                 'ids' => [44,45,46,47,48,49,50],                         'roll' => 1],
    ['title' => 'Franchise Reports',  'ids' => [51,52,53,54,55,56,57,58,59],                   'roll' => 1],
...
$franchiseSections = [
    ...
    ['title' => 'Receive Stocks',      'ids' => [109,110,111,128],                      'roll' => 2],
                                       ...
                                       <!-- <div class="form-group col-md-3">
                                         ...
                                         <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" name="Designation" id="Designation">
                                                ...
                                                <?php 
                                        $q = "select * from tbl_user_type WHERE Status=1 AND id NOT IN (1,3,5,55,63,96,166,93) ORDER BY Name";
                                        $r = $conn->query($q);
...
<fieldset>
    <legend>
        ...
        <input type="checkbox" id="selectAllCoco" style="margin-left:10px;">  Franchise Access
    </legend>
