...
<?php 
$id = $_GET['id'];
$query = "SELECT * FROM tbl_transfer_franchise_prod_stock_2025 WHERE id = '$id'";
$row = getRecord($query);

  
$sql7 = "SELECT * FROM tbl_users_bill WHERE id='".$row['ToFrId']."'";
$row7 = getRecord($sql7);
...
Mobile: <?php echo $row7['Phone'];?><br></div>
        ...
        <?php 
$i=1;
$sql44 = "SELECT ttg.*,tgp.ProductName FROM tbl_transfer_franchise_prod_stock_items_2025 ttg LEFT JOIN tbl_cust_products_2025 tgp ON ttg.ProdId=tgp.id WHERE ttg.TransferId='$id'";
$row44 = getList($sql44);
