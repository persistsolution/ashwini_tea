...
if($_REQUEST["action"]=="delete")
{
  ...
  ?>
    <script type="text/javascript">
      ...
      window.location.href="view-transfer-franchise-to-franchise-raw-stock.php";
    </script>
<?php } } ?>
...
<h4 class="font-weight-bold py-3 mb-0">Transfer Raw Stock Franchise To Franchise
  <?php if(in_array("14", $Options)) {?> 
<span style="float: right;">
<a href="add-transfer-franchise-to-franchise-raw-stock.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            LEFT JOIN tbl_users_bill tu2 ON tu2.id=tp.ToFrId WHERE tp.FromFrId='$BillSoftFrId' AND tp.ProdType=1
            ...
            <tr>
               ...
               <td><a href="view-transfer-raw-product-list.php?id=<?php echo $row['id']; ?>" target="_blank">View (<?php echo $rncnt2; ?>)</a></td> 
