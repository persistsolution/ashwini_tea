...
if($row_cnt > 0){
 ...
 $qx = "INSERT INTO tbl_cust_category_2025 SET ProdType=1,Name = '$Name', Icon = '$Icon',Status='$Status',Featured='$Featured',Photo='$Photo',Photo2='$Photo2',CreatedDate='$CreatedDate',Roll='$Roll',srno='$srno',OldNew='$OldNew'";
  $conn->query($qx);
  echo 1;
}
}
...
if($row_cnt > 0){
  ...
  $query2 = "UPDATE tbl_cust_category_2025 SET ProdType=1,Name = '$Name',Icon = '$Icon',Status='$Status',Featured='$Featured',Photo='$Photo',Photo2='$Photo2',ModifiedDate='$ModifiedDate',Roll='$Roll',srno='$srno',OldNew='$OldNew' WHERE id = '$id'";
  $conn->query($query2);
  echo 1;
}
}
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
          <?php 
 $srno = 1;
  $sql = "SELECT * FROM tbl_cust_category_2025 WHERE ProdType=1 ORDER BY id DESC";
   $rx = $conn->query($sql);
