...
$CustomerId = "C".$EmpId;
$sql3 = "UPDATE tbl_users_bill SET ZoneId='$ZoneId',Barcode='$Barcode',CustomerId='$CustomerId' WHERE id='$EmpId'";
$conn->query($sql3);
 ...
 $rncnt2 = getRow($sql2);
 if($rncnt2 > 0){
     echo "<script>alert('Phone No Already Exists!');window.location.href='../view-distributers.php?id=$id';</script>";
 }  
 else{
//      $filename = $id.".png";
// $codeContents = $Phone;
