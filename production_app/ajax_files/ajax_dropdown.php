...
//echo $q;
   ...
   while ($rw = $r->fetch_assoc()) {
    ...
    if($_POST['action'] == 'getGodownProdList'){
...
$q = "SELECT id,ProductName,MinPrice FROM tbl_cust_products2 WHERE Status='1' AND ProdType2='3' AND ProdType=0 AND (ProductName LIKE '%$ProdName%')";
$q.=" ORDER BY ProductName";
    $r = $conn->query($q);
