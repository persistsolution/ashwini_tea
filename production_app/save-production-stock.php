...
$SrNo = $row['NextId'];
$sql = "INSERT INTO tbl_production_inv SET VedId='$VedId',FrId='$fr_id',SrNo='$SrNo',InvNo='$InvNo',StockDate='$StockDate',TotalQty='$TotQty',Narration='$Narration',bill='$bill',CreatedBy='$user_id',CreatedDate='$CreatedDate'";
$conn->query($sql);
