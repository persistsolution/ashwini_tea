...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-production.php" class="btn btn-sm btn-default rounded">Add New</a>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                ...
                <div><span class="info-label">Production Qty:</span><span class="info-value"><?php echo $totalProductsQty['TotQty']; ?></span></div>
               
               
                
            </div>
            <div class="col-auto d-flex align-items-center">
                <a href="view-production-products.php?id=<?php echo $result['id']; ?>" class="btn btn-success btn-sm rounded-pill px-3">
                    View
                </a>
            </div>
        </div>
