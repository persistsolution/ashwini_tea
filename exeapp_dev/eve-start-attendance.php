        ...
        <input type="hidden" name="date" id="CreatedDate" value="<?php echo date('Y-m-d');?>">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 ">
                     ...
                     <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div class="form-group float-label active">
                            <input type="number" class="form-control" value="<?php echo $ReceivedAmt;?>" required name="HandoverAmt" min="1" readonly>
                            <label class="form-control-label">Cash Received</label>
                        </div>
                    </div>
