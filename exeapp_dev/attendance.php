...
$sql331 = "SELECT HandoverAmt FROM tbl_attendance WHERE HandoverUserId='$UserId' AND CreatedDate='".date('Y-m-d')."' LIMIT 1";
$rncnt331 = getRow($sql331);
$row331 = getRecord($sql331);
$ReceivedAmt = $row33['HandoverAmt'];
?>
<!doctype html>
