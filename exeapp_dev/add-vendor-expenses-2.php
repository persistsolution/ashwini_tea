    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="VedName" id="VedName" placeholder="Search vendor, Trade Name..." value="<?php echo $VedName; ?>" required autofocus onclick="this.select();">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach(function(item) {
                            $("#autocomplete-list").append(`<div class="autocomplete-item" onclick="getVedDetails(${item.id})">${item.Fname} (${item.TradeName}) - ${item.Phone}</div>`);
                        });
