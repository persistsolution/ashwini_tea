...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2025 at 10:45 AM
...
(4, 11, 'RK Distrubuters', '', '8976564534', '', 0, 0, 0, 0, 'Nagpur', '', 1, '2025-09-19', 0);
...
--
-- Table structure for table `tbl_distributer_inv`
--

CREATE TABLE `tbl_distributer_inv` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_distributer_inv`
--

INSERT INTO `tbl_distributer_inv` (`id`, `ProductionId`, `DistId`, `SrNo`, `InvNo`, `StockDate`, `TotalQty`, `Narration`, `bill`, `CreatedBy`, `CreatedDate`, `ProdType`) VALUES
(1, 9, 11, 1, 'P001', '2025-09-19', 25, 'test', '', 9, '2025-09-19 01:19:47', 0);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_distributer_stock`
--

CREATE TABLE `tbl_distributer_stock` (
  `id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `tbl_distributer_stock`
--

INSERT INTO `tbl_distributer_stock` (`id`, `ProductionId`, `DistId`, `MainProdId`, `ProdId`, `Qty`, `Unit`, `Qty2`, `Unit2`, `Status`, `StockDate`, `CreatedDate`, `Narration`, `Main`, `CreatedBy`, `ModifiedBy`, `ModifiedDate`, `InvId`, `PurchasePrice`, `SellPrice`, `ProdType`, `ProdType2`) VALUES
(1, 9, 11, 0, 45, 10, NULL, NULL, NULL, 'Cr', '2025-09-19', '2025-09-19 01:19:47', 'test', 0, 9, 0, NULL, 1, '', '', 0, 0),
(2, 9, 11, 0, 21, 15, NULL, NULL, NULL, 'Cr', '2025-09-19', '2025-09-19 01:19:47', 'test', 0, 9, 0, NULL, 1, '', '', 0, 0);
...
(4, 1, '2025-09-19', '00:12:15'),
(5, 1, '2025-09-19', '00:19:49');
...
--
-- Table structure for table `tbl_production_inv`
--

CREATE TABLE `tbl_production_inv` (
  `id` int(11) NOT NULL,
  `VedId` int(11) NOT NULL,
  `FrId` int(11) NOT NULL,
  `SrNo` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_production_inv`
--

INSERT INTO `tbl_production_inv` (`id`, `VedId`, `FrId`, `SrNo`, `InvNo`, `StockDate`, `TotalQty`, `Narration`, `bill`, `CreatedBy`, `CreatedDate`, `ProdType`, `AdminStatus`, `AdminBy`, `AdminApproveDate`, `AdminComment`, `AccountantApproveDate`, `AccountantComment`, `AccountantStatus`, `AccountantBy`, `PurchaseBy`, `PurchaseApproveDate`, `PurchaseComments`, `PurchaseStatus`) VALUES
(1, 0, 9, 1, 'P001', '2025-09-18', 65, 'dd', '', 9, '2025-09-18 22:16:01', 0, 0, 0, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, 0);
...
CREATE TABLE `tbl_production_stock` (
  `id` bigint(20) NOT NULL,
  `DistId` int(11) NOT NULL,
  `MainProdId` int(11) NOT NULL,
  `ProdId` int(11) NOT NULL,
  ...
  `ModifiedDate` datetime DEFAULT NULL,
  `InvId` int(11) NOT NULL,
  `FrId` int(11) NOT NULL COMMENT 'Production Login Id',
  `TransferId` int(11) NOT NULL,
  `PurchasePrice` varchar(50) DEFAULT NULL,
  `SellPrice` varchar(50) DEFAULT NULL,
  `InvoiceId` text DEFAULT NULL,
...
--
-- Dumping data for table `tbl_production_stock`
--

INSERT INTO `tbl_production_stock` (`id`, `DistId`, `MainProdId`, `ProdId`, `UserId`, `Qty`, `Unit`, `Qty2`, `Unit2`, `Status`, `StockDate`, `CreatedDate`, `Narration`, `Main`, `CreatedBy`, `ModifiedBy`, `ModifiedDate`, `InvId`, `FrId`, `TransferId`, `PurchasePrice`, `SellPrice`, `InvoiceId`, `ProdType`, `ProdType2`, `Wastage`, `checkstatus`, `VedExp`, `PurchaseBy`, `PurchaseDate`, `PurchaseStatus`, `PurchaseComment`, `PurchaseQty`) VALUES
(1, 0, 0, 45, 0, 20, NULL, NULL, NULL, 'Cr', '2025-09-18', '2025-09-18 22:16:01', 'dd', 0, 9, 0, NULL, 1, 9, 0, '', '', NULL, 0, 0, 0, 0, 'No', 0, NULL, 0, 'Pending', '20'),
(2, 0, 0, 21, 0, 30, NULL, NULL, NULL, 'Cr', '2025-09-18', '2025-09-18 22:16:01', 'dd', 0, 9, 0, NULL, 1, 9, 0, '', '', NULL, 0, 0, 0, 0, 'No', 0, NULL, 0, 'Pending', '30'),
(3, 0, 0, 34, 0, 15, NULL, NULL, NULL, 'Cr', '2025-09-18', '2025-09-18 22:16:01', 'dd', 0, 9, 0, NULL, 1, 9, 0, '', '', NULL, 0, 0, 0, 0, 'No', 0, NULL, 0, 'Pending', '15'),
(4, 11, 0, 45, 9, 10, NULL, NULL, NULL, 'Dr', '2025-09-19', '2025-09-19 01:19:47', 'test', 0, 9, 0, NULL, 1, 9, 0, '', '', NULL, 0, 0, 0, 0, 'No', 0, NULL, 0, 'Trasfer to distributer', '10'),
(5, 11, 0, 21, 9, 15, NULL, NULL, NULL, 'Dr', '2025-09-19', '2025-09-19 01:19:47', 'test', 0, 9, 0, NULL, 1, 9, 0, '', '', NULL, 0, 0, 0, 0, 'No', 0, NULL, 0, 'Trasfer to distributer', '15');
...
(11, 'C11', NULL, NULL, 'RK Distrubuters', '', '', '8976564534', '', '', '12345', 0, 0, 0, NULL, 'Nagpur', '', '', '', '', '', '', 166, 1, 1, 1, '2025-09-19', '2025-09-19', '', '', '0000-00-00', NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 0, '', '', '', NULL, NULL, NULL, NULL, NULL, 0, '', '', '', '0000-00-00', '', 0.00, '', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, '0000-00-00', '', 0, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '', NULL, 0, 0, '0000-00-00 00:00:00', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Old', 0, 60, 5, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No', 0, 0, NULL, 'No', NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, 0, '', 'No', 0, NULL, NULL, 0, NULL, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
(1, 'Maharashtra', NULL, 1),
(2, 'Uttar Pradesh', NULL, 1),
(3, 'Panjim', NULL, 1),
(4, 'Himachal Pradesh', NULL, 1),
(5, 'Haryana', NULL, 1),
(6, 'Madhya Pradesh', NULL, 1),
(7, 'Andhra Pradesh', NULL, 1),
(8, 'Arunachal Pradesh', NULL, 1),
(9, 'Assam', NULL, 1),
(10, 'Bihar', NULL, 1),
(11, 'Chhattisgarh', NULL, 1),
(12, 'Goa', NULL, 1),
(13, 'Gujarat', NULL, 1),
(14, 'Jharkhand', NULL, 1),
(15, 'Karnataka', NULL, 1),
...
(23, 'Rajasthan', NULL, 1),
(24, 'Sikkim', NULL, 1),
(25, 'Tamil Nadu', NULL, 1),
(26, 'Tripura', NULL, 1),
(27, 'Telangana', NULL, 1),
(28, 'Uttarakhand', NULL, 1),
(29, 'West Bengal', NULL, 1),
(30, 'Andaman & Nicobar (UT)', NULL, 1),
(31, 'Chandigarh (UT)', NULL, 1),
(32, 'Dadra & Nagar Haveli and Daman & Diu (UT)', NULL, 1),
(33, 'Delhi [National Capital Territory (NCT)]', NULL, 1),
(34, 'Jammu & Kashmir (UT)', NULL, 1),
(35, 'Ladakh (UT)', NULL, 1),
(36, 'Lakshadweep (UT)', NULL, 1),
(37, 'Puducherry (UT)', NULL, 1);
...
--
-- Indexes for table `tbl_distributer_inv`
--
ALTER TABLE `tbl_distributer_inv`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_distributer_stock`
--
ALTER TABLE `tbl_distributer_stock`
  ADD PRIMARY KEY (`id`),
  ADD KEY `StockDate` (`StockDate`),
  ADD KEY `ProdId` (`ProdId`),
...
--
-- Indexes for table `tbl_production_inv`
--
ALTER TABLE `tbl_production_inv`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_production_stock`
--
ALTER TABLE `tbl_production_stock`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FrId` (`FrId`),
  ADD KEY `StockDate` (`StockDate`),
  ADD KEY `ProdId` (`ProdId`),
...
--
-- AUTO_INCREMENT for table `tbl_distributer_inv`
--
ALTER TABLE `tbl_distributer_inv`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_distributer_stock`
--
ALTER TABLE `tbl_distributer_stock`
...
--
-- AUTO_INCREMENT for table `tbl_production_inv`
--
ALTER TABLE `tbl_production_inv`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_production_stock`
--
ALTER TABLE `tbl_production_stock`
